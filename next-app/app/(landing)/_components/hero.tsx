...
export default function Hero() {
  return (
    <ScrollReveal
      preset={false}
      className="flex flex-col gap-10 w-full mt-13 sm:mt-32 items-center justify-between"
    >
      ...
      {/* Text */}
      <div className="flex flex-col gap-5 sm:gap-10 mx-5 items-center w-full">
      ...
      {/* Buttons */}
      <RevealItem delayIndex={2} className="w-full flex justify-center">
      ...
      <RevealItem delayIndex={3} direction="up" className="w-full">
