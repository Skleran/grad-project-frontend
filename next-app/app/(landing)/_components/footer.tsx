...
export function Footer() {
  return (
    <footer className="relative w-full bg-background border-t border-border/40 overflow-hidden pt-16 pb-8 flex flex-col items-center">
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 z-10 mb-24 md:mb-32">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 pt-2 border-t border-border/50 z-10">
